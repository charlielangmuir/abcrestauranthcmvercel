          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-md space-y-4">
              <div>
                ...
                <div className="text-gray-800 bg-gray-50 px-4 py-2 rounded-lg">John Peterson</div>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Role</label>
                <div className="text-gray-500 bg-gray-50 px-4 py-2 rounded-lg">Restaurant Manager</div>
              </div>
