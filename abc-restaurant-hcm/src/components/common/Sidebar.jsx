...
const Sidebar = ({ isOpen }) => {
  ...
  const schedulePath = role === 'MANAGER' || role === 'ADMIN' ? '/schedule' : '/view-schedule';
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 right-4 p-3 bg-gray-100 rounded-lg">
        <p className="text-xs text-gray-600 font-medium">Current Role</p>
